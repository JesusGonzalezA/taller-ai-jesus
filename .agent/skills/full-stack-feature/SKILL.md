...
description: Cómo implementar una feature completa que afecta a frontend y backend. Usa esta skill cuando la feature requiera cambios tanto en el frontend como en el backend.
---
...
1. Crea la ruta → sigue la skill `backend-dev`
2. Escribe los tests del backend
3. Verifica: `npm run test --workspace=backend`

### 3. Implementa el frontend

1. Crea el componente/página → sigue la skill `frontend-dev`
